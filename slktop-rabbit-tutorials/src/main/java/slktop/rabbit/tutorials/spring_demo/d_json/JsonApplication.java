package slktop.rabbit.tutorials.spring_demo.d_json;
...
public class JsonApplication {
	...
	public static void main(String[] args) throws Exception {
		ConfigurableApplicationContext ctx = SpringApplication.run(JsonApplication.class, args);
		ctx.getBean(JsonApplication.class).runDemo();
		ctx.close();
	}
	...
	public SimpleMessageListenerContainer legacyPojoListener(ConnectionFactory connectionFactory) {
		...
		MessageListenerAdapter messageListener = new MessageListenerAdapter(new Object() {
			...
			public void handleMessage(Object object) {
				...
				JsonApplication.this.latch.countDown();
			}
